...
class Game {
  ...
  playerCollide() {
    for(let i = 0; i < this.centipede.segArray.length; i++) {
      if ((this.centipede.segArray[i].x >= this.player.x) && 
        (this.centipede.segArray[i].x <= this.player.x + this.player.width) && 
        (this.centipede.segArray[i].y >= this.player.y) && 
        (this.centipede.segArray[i].y <= (this.player.y + this.player.height))) {
        this.restartGame();
